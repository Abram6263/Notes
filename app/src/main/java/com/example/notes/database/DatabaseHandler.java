...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "notes_list_3";
    private static final String TABLE_NAME = "notes";
    private static final String KEY_ID = "id";
    private static final String KEY_TITLE = "title";
    private static final String KEY_TEXT = "note";
    private static final String[] COLS_ID_TITLE_NOTE = new String[] {KEY_ID,KEY_TITLE,KEY_TEXT};
